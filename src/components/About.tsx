    ...
    <div className='portfolio-section' aria-label='about'>
        <div className='about'>
          ...
          <div className='about-info'>
              ...
              <hr className='line'/>
              <p className='summary'>Hello! I'm a junior Computer Science major <span className='text-accent'>@</span> the Raikes School. I enjoy full-stack software development and problem solving.</p>
              <hr className='line'/>
              <div className='links'>
